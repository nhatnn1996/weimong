...
const Partner = () => {
  return (
    <div className="bg-[#242424]">
      ...
      <div className="mandaloretitle opacity-75 text-stroke text-transparent text-6xl lg:text-8xl tracking-[2px] lg:tracking-[16px] px-10 lg:px-0">
          wei-contact
        </div>
        <div className="border-t-[1px] border-[#707070] mt-12 pb-32 lg:pb-0 bg-[url('/images/spacex/footer.png')] px-10 bg-cover bg-no-repeat bg-left-bottom py-24">
