  ...
  return (
    <div className="bg-[#242424] pt-10 lg:py-20 px-4 lg:px-0">
      <div className=" w-auto lg:w-[90rem] mx-auto">
        <div className="mandaloretitle top-0 left-0 opacity-75 text-stroke text-transparent text-6xl lg:text-8xl tracking-[2px] lg:tracking-[16px]">
          wei-tech
        </div>
        ...
        <div className="lg:flex py-20">
          ...
          <div className="w-full lg:w-4/12 mt-16 lg:mt-0 px-10 lg:px-0">
            <div className="text-3xl tracking-[2px] lg:tracking-[14px] opacity-40 mandalorecond pb-3 lg:pb-10 lg:mb-10 lg:border-b-[2px] border-[#FFFFFF66]">
              The Soyuz Tma-9
            </div>
