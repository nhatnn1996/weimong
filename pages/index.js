...
export default function Home() {
  return (
    <div className="">
      ...
      <div>
        <div className="bg-[#222222] text-white relative z-10 bg-[url(/images/weimong/bg-home.png)] bg-[length:100%_auto] bg-no-repeat">
          <div className="flex flex-col justify-between h-screen min-h-[calc(9/16*100vw)] relative z-30">
