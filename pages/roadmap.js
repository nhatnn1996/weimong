...
export default function Roadmap() {
  return (
    <div>
      <div className="py-10">
        <div className="flex py-[5rem] px-[3.5rem] xl:px-[12rem] flex-wrap">
          <div className="w-1/2 pr-6">
            <div className="w-[35rem] h-[19.375rem]">
              <Image priority src={'/images/weimong/free.png'} alt="not found image" width={'100%'} height={'55%'} layout="responsive" />
            </div>
          </div>
